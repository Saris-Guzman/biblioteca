...
class LibroController extends Controller
{
    ...
    public function create()
    {
        ...
        $editorials = Editorial::pluck('nombre','id');

        return view('libro.create', compact('libro','categorias','autors','editorials'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('libro.edit', compact('libro','categorias','autors','editorials'));
    }
